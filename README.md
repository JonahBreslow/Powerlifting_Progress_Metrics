...
API will not work.
+ I employed a virtual environment for python3.8. All necessary packages are in requirements.txt file. Please create and activate a virtual environment on your machine by running the following shell command in the project directory:
```shell
