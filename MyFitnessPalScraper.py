...
# Get account info
client = myfitnesspal.Client('Jonahbreslow2019','Jonahb123')
# Set start year
startYear = "2020"
# Get limits
...
for yearIndex in range(beginningYear, currentYear+1):
    ...
    if(row_count < 365):
        ...
        writer.writerow(["Date", "Calories", "Carbohydrates", "Fat", "Protein","Sodium", "Sugar",  "Weight"])
        ...
        for monthIndex in range(1, 12+1):
            ...
            for dayIndex in range(1, daysInMonth[monthIndex]+1):
                ...
                dataRow = list([fullDateIndex]) + list(thisDaysNutritionValues)  + list(thisDaysWeight)
                if dataRow:
